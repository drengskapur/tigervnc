...
LABEL org.opencontainers.image.base.name="ubuntu" \
      ...
      org.opencontainers.image.description="Base Ubuntu image for TigerVNC implementation" \
...
LABEL org.opencontainers.image.base.name="tigervnc-base" \
      org.opencontainers.image.description="Base TigerVNC image with common dependencies" \
      org.opencontainers.image.source="https://github.com/drengskapur/tigervnc"
...
RUN echo "#!/bin/bash" > /usr/local/bin/entrypoint.sh && \
    ...
    echo "}" >> /usr/local/bin/entrypoint.sh && \
    echo "" >> /usr/local/bin/entrypoint.sh && \
    echo "log \"Starting TigerVNC services\"" >> /usr/local/bin/entrypoint.sh && \
    echo "" >> /usr/local/bin/entrypoint.sh && \
...
LABEL org.opencontainers.image.version="tigervnc-base"
